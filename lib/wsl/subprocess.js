...
import { spawnWslTerminal } from './pty.js'
import { buildWslExecArgv, planWsl, runWslShell, withWslEnvFlags } from './world.js'
...
export class WslSubprocessRuntime extends SubprocessRuntime {
  ...
  async spawnTerminal(spec) {
    ...
    return spawnWslTerminal({
      ...
      env: { ...withWslEnvFlags(spec.env ?? {}), TERM: spec.terminalType },
